...
var stalactite = (function(a){function D(h){h=h[0];for(var a=0;a<l.length;a++)if(h===l[a].dom)return a;return-1}function E(a,f){var n=a.children().not(f.cssSelector);f.cssPrep&&n.css({position:"relative",display:"inline-block",verticalAlign:"top",opacity:0,zIndex:-1});return n}function B(a,f,n,r){r=a.children().addClass(r.cssSelector);var c=(a.outerHeight(!0)-a.outerHeight())/2,d=(a.outerWidth(!0)-a.outerWidth())/2;a={x:a.offset().left-d,y:a.offset().top-c};f.call(this,r,a,n.prevMinIndex,n.prevMaxIndex,n.i)}var l=
...
styles:{},complete:function(a){return a}}});